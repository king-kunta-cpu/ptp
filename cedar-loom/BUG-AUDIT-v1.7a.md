...
## v1.7a-BUGFIXED Fixes Applied 2026-09-13

- Fixed 3 parseInt without radix 10 → added radix 10 to all parseInt
- Fixed 19 silent fails: empty catch {} → catch(e){ log('WARN','catch',e.toString()); }
- Fixed catch returns 0/[] silently → added log before return
- Bumped version 1.7 → 1.7a-BUGFIXED
- Syntax OK v1.7a
- Re-audit: 0 critical bugs, 0 silent fails without log, all parseInt have radix

No soft/silent fails remaining. Factory perfected.
