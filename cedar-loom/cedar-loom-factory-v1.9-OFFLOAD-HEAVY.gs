...
var CL_VERSION = '1.9-OFFLOAD-HEAVY';
...
var CL = {
  ...
  OFFLOAD_RATIO: 80, // 80% work off Apps Script to GitHub Actions free 2000m
...
function clMain(){
  return withLock('clMain', function(){
    ...
    if(isHeavy){
      ...
      try{ if((getConfig('CLOUDFLARE_WORKER_URL','')+'').trim()) { /* Worker does batch distribute */ } }catch(e){}
